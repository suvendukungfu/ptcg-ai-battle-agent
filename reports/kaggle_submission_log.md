...
| :---: | :--- | :--- | :---: | :---: | :---: | :---: | :---: |
| **`SUB-01-PRIMARY`** | **Candidate D (Crustle Control)** | Safeguard (*Mysterious Rock Inn*) Immunity Wall vs Pokémon ex | **100.0% (40/40)** | **[91.2%, 100.0%]** | **3.75 ms** | **0.00%** | **ACTIVE (Primary Target)** |
