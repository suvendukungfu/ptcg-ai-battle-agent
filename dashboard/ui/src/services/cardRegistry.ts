...
export const CARD_REGISTRY: Record<number, CardMeta> = {
  ...
  723: {
    ...
    fallbackImg: 'https://images.pokemontcg.io/sv3/79.png',
  ...
  722: {
    ...
    fallbackImg: 'https://images.pokemontcg.io/sv1/78.png',
  ...
  721: {
    ...
    fallbackImg: 'https://images.pokemontcg.io/sv1/77.png',
  ...
  345: {
    ...
    fallbackImg: 'https://images.pokemontcg.io/sv1/6.png',
  ...
  344: {
    ...
    retreat: 2,
    weakness: 'Fire',
    img: 'https://images.pokemontcg.io/sv1/5_hires.png',
    fallbackImg: 'https://images.pokemontcg.io/sv1/5.png',
  ...
  743: {
    ...
    retreat: 1,
    weakness: 'Darkness',
    img: 'https://images.pokemontcg.io/sv1/107_hires.png',
    fallbackImg: 'https://images.pokemontcg.io/sv1/107.png',
  ...
  742: {
    ...
    retreat: 1,
    weakness: 'Darkness',
    img: 'https://images.pokemontcg.io/sv1/106_hires.png',
    fallbackImg: 'https://images.pokemontcg.io/sv1/106.png',
  ...
  741: {
    ...
    retreat: 1,
    weakness: 'Darkness',
    img: 'https://images.pokemontcg.io/sv1/105_hires.png',
    fallbackImg: 'https://images.pokemontcg.io/sv1/105.png',
