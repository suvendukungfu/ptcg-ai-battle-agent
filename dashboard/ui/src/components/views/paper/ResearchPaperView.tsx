  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 text-left pb-16 pt-2">
      ...
      <div className="space-y-3 text-sm text-slate-300 leading-relaxed">
        <h2 className="text-lg font-black text-white tracking-tight flex items-center gap-2 border-b border-white/8 pb-1">
        ...
        <div className="p-4 rounded-xl bg-white/2 border border-white/6 font-mono text-xs text-indigo-200 space-y-1">
      ...
      <div className="space-y-3 text-sm text-slate-300 leading-relaxed">
        ...
        <div className="p-4 rounded-xl bg-white/2 border border-white/6 font-mono text-xs text-indigo-200">
          ...
          <table className="w-full text-xs font-mono border-collapse border border-white/10">
            ...
            <tbody>
              <tr className="border-b border-white/6">
                ...
                <td className="p-2.5">Rule heuristic priorities</td>
                <td className="p-2.5 text-rose-400">40.0%</td>
              ...
              <tr className="border-b border-white/6">
                ...
                <td className="p-2.5">Multi-factor V(s) evaluation</td>
                <td className="p-2.5 text-indigo-300">50.0%</td>
                <td className="p-2.5">[29.9%, 70.1%]</td>
                <td className="p-2.5">0.030 ms</td>
              </tr>
              <tr className="border-b border-white/6">
                <td className="p-2.5 font-bold text-white">C: Rules + Search</td>
                <td className="p-2.5">1-ply state lookahead</td>
                <td className="p-2.5 text-indigo-300">45.0%</td>
                <td className="p-2.5">[25.8%, 65.8%]</td>
                <td className="p-2.5">4.323 ms</td>
              </tr>
              <tr className="border-b border-white/6">
                <td className="p-2.5 font-bold text-white">D: Opponent Model</td>
                <td className="p-2.5">Hypergeometric threat belief</td>
                <td className="p-2.5 text-indigo-300">55.0%</td>
                <td className="p-2.5">[34.2%, 74.2%]</td>
                <td className="p-2.5">0.043 ms</td>
              </tr>
              <tr className="border-b border-white/6">
                <td className="p-2.5 font-bold text-white">E: Search + Threat</td>
                <td className="p-2.5">Search with retaliation penalty</td>
                <td className="p-2.5 text-indigo-300">62.0%</td>
                <td className="p-2.5">[57.1%, 66.8%]</td>
                <td className="p-2.5">4.492 ms</td>
              </tr>
              <tr className="bg-indigo-950/40 border-b border-indigo-500/30">
                <td className="p-2.5 font-bold text-emerald-400">F: Full System</td>
                <td className="p-2.5 font-bold text-white">Production Agent + Dynamic Risk</td>
                <td className="p-2.5 font-bold text-emerald-400">68.2%</td>
