  ...
  return (
    <div className="space-y-6 text-left pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-3 border-b border-white/8">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs px-2.5 py-0.5 rounded-full bg-indigo-500/10 text-indigo-300 border border-indigo-500/30 font-mono font-bold">
              Imperfect Information Modeling
            </span>
          </div>
        ...
        <div className="flex items-center gap-2">
          <span className="text-xs font-mono px-3 py-1 rounded-xl bg-purple-500/10 border border-purple-500/30 text-purple-300 font-bold">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="glass-panel p-5 rounded-2xl border border-white/8 space-y-3 relative overflow-hidden">
          <div className="flex justify-between items-center text-xs">
            <span className="font-bold text-white flex items-center gap-1.5">
              <Target className="w-4 h-4 text-rose-400" />
              P(Boss's Orders)
            </span>
            <span className="text-xs font-mono font-bold text-rose-400">{probBoss}%</span>
          </div>
        ...
        <div className="glass-panel p-5 rounded-2xl border border-white/8 space-y-3 relative overflow-hidden">
          <div className="flex justify-between items-center text-xs">
            ...
            <span className="text-xs font-mono font-bold text-amber-400">{probEnergy}%</span>
          </div>
          <div className="w-full h-2 rounded-full bg-white/6 overflow-hidden">
        ...
        <div className="glass-panel p-5 rounded-2xl border border-white/8 space-y-3 relative overflow-hidden">
          <div className="flex justify-between items-center text-xs">
            ...
            <span className="text-xs font-mono font-bold text-indigo-300">{probEvo}%</span>
          </div>
          <div className="w-full h-2 rounded-full bg-white/6 overflow-hidden">
        ...
        <div className="glass-panel p-5 rounded-2xl border border-white/8 space-y-3 relative overflow-hidden">
          <div className="flex justify-between items-center text-xs">
            ...
            <span className="text-xs font-mono font-bold text-emerald-400">{probSwitch}%</span>
          </div>
          <div className="w-full h-2 rounded-full bg-white/6 overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 glass-panel p-5 rounded-2xl border border-white/8 space-y-4">
          ...
          <div className="p-4 rounded-xl bg-indigo-950/40 border border-indigo-500/20 text-xs font-mono space-y-2">
          ...
          <div className="text-xs text-slate-300 leading-relaxed space-y-2">
            ...
            <p className="text-slate-400 text-[11px]">
              When the probability of a lethal gust attack P(Boss) &gt; 40%, the action selector automatically adapts its dynamic risk profile from <span className="text-indigo-300 font-mono">AGGRESSIVE</span> to <span className="text-rose-400 font-mono">DEFENSIVE</span>, prioritizing bench protection and energy preservation.
            </p>
        ...
        <div className="lg:col-span-5 glass-panel p-5 rounded-2xl border border-white/8 space-y-4">
          <div className="flex items-center justify-between pb-2 border-b border-white/8">
            <span className="text-xs font-bold text-white uppercase tracking-wider font-mono flex items-center gap-1.5">
          ...
          <div className="space-y-3 text-xs">
            <div className="p-3 rounded-xl bg-white/2 border border-white/6 space-y-1 font-mono">
