  ...
  return (
    <div className="space-y-6 text-left pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-3 border-b border-white/8">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs px-2.5 py-0.5 rounded-full bg-amber-400/10 text-amber-300 border border-amber-400/30 font-mono font-bold flex items-center gap-1.5">
        ...
        <div className="flex items-center gap-2 font-mono">
          <button
            ...
            className="px-4 py-2 rounded-xl text-xs font-black bg-amber-500 hover:bg-amber-400 text-black shadow-lg shadow-amber-500/20 flex items-center gap-1.5 transition-all cursor-pointer"
          >
          ...
          <button
            ...
            className="px-4 py-2 rounded-xl text-xs font-bold bg-white/4 hover:bg-white/8 text-slate-200 border border-white/8 flex items-center gap-1.5 transition-all cursor-pointer"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* Elo Rating */}
        <div className="glass-panel p-5 rounded-3xl border border-white/8 relative overflow-hidden">
          ...
          <div className="flex items-center gap-1 text-[11px] text-emerald-400 font-mono font-bold mt-2">
        ...
        <div className="glass-panel p-5 rounded-3xl border border-white/8 relative overflow-hidden">
          ...
          <div className="text-[11px] text-cyan-400 mt-2 font-mono">
            Avg: {status ? `${status.avg_decision_time_ms.toFixed(2)} ms` : '1.23 ms'} (Limit: 25ms)
          </div>
          <div className="absolute right-0 bottom-0 translate-x-2 translate-y-2 opacity-5 pointer-events-none">
        ...
        <div className="glass-panel p-5 rounded-3xl border border-white/8 relative overflow-hidden">
          ...
          <div className="text-[11px] text-emerald-400 font-mono font-bold mt-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-6 glass-panel p-6 rounded-3xl border border-white/8 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
            ...
            <div className="p-3.5 rounded-2xl bg-white/2 border border-white/5 space-y-2">
              ...
              <button
                ...
                className="w-full mt-1 py-1.5 rounded-xl bg-white/4 hover:bg-white/8 text-[10px] font-mono font-bold text-slate-300 hover:text-white transition-colors cursor-pointer"
              >
                Inspect Opponent Intel →
              </button>
            </div>
